...
public class SMDIYEngine {
	...
	public SMDIYEngine(ArrayList<ObjectsInSpace> objects,DrawParticle part,boolean hasStrom){
	...
	public void update(){
		...
		for(int i=0;i<objects.size();i++){
			if(objects.get(i).getIdentity()==5){
				Area shipArea = ship.spaceshipRect();
				SlowArea slow = (SlowArea)objects.get(i);
				shipArea.intersect(slow.slowArea());
				
				System.out.println(shipArea.isEmpty());
