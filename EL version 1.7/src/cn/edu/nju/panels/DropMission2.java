...
import cn.edu.nju.waterDropTools.WDM2Object;
import cn.edu.nju.waterDropTools.WaterDrop;

public class DropMission2 extends BackgroundPanel{

	/**
	 * 
	 */
	private static final long serialVersionUID = 5033022018209359266L;
	...
	public DropMission2(){
       ...
       CanBeCutObject ob;
       for(int i=0;i<5;i++){
    	   double theta = -(5.0/6)*Math.PI+i*(1.0/6)*Math.PI;
    	   ob = new WDM2Object(maker.getEllipse(75, 75),640, 360, 0,0,theta);
    	   objects.add(ob);
       }
	...
	//	 int[] x = {484,550,640,730,796};
	//	 int[] y = {270,204,180,204,279};
	       CanBeCutObject ob;
	       for(int i=0;i<5;i++){
	    	   double theta = -(5.0/6)*Math.PI+i*(1.0/6)*Math.PI;
