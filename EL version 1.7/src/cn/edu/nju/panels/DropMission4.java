...
import cn.edu.nju.waterDropTools.WDM4Engine;
import cn.edu.nju.waterDropTools.WDM4Object;
import cn.edu.nju.waterDropTools.WaterDrop;

public class DropMission4 extends BackgroundPanel{
	...
	WaterDrop drop = new WaterDrop(640, 360, 0, 0);
	WDM4Engine engine ;
	...
	public DropMission4(){
		...
		part = new DrawParticle();
			...
			CanBeCutObject ob;
	       Area emptyEllipse1 = maker.getEllipse(215, 160);
	       emptyEllipse1.subtract(maker.getEllipse(190, 140));
	       Area emptyEllipse2 = maker.getEllipse(160, 215);
	       emptyEllipse2.subtract(maker.getEllipse(140, 190));
	       emptyEllipse1.add(emptyEllipse2);
	       ob = new WDM3Object(emptyEllipse1, 640, 360, 0, 0);
	       objects.add(ob);
	       
	       ob = new WDM4Object(maker.getEllipse(80, 80), 320, 360, 2, -7);
	       objects.add(ob);
	       ob = new WDM4Object(maker.getEllipse(80, 80), 320+640, 360, -2, 7);
	       objects.add(ob);
       
       
       
       engine = new WDM4Engine(drop, objects,part);
	...
	public void init(){
		super.init();
		 ...
		 maker = new AreaMaker();
		 drop = new WaterDrop(640, 360, 0, 0);
